...
In a dashboard, a chart can be configured to have a custom refresh rate. Using the new "query your data" experience, the refresh rate can be configured to either be:
* disabled,
* a value between 5 seconds and 24 hours,
* or 'auto'. When 'auto' is selected, the refresh rate is determined by the query's timeframe divided by 60 or the TIMESERIES bucket size as explained above.
